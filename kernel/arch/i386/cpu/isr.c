...
static inline void _isr_outb(uint16_t port, uint8_t val)
{
...
{
    const char *name =
        (frame->int_no < 32) ? g_exception_names[frame->int_no] : "Unknown interrupt";

    _isr_write_str("\r\n\r\n[KERNEL PANIC] Unhandled exception: ");
    _isr_write_str(name);
    _isr_write_str("\r\n");
    _isr_write_str("  int_no  = "); _isr_write_hex32(frame->int_no);   _isr_write_str("\r\n");
    _isr_write_str("  err_code= "); _isr_write_hex32(frame->err_code); _isr_write_str("\r\n");
    _isr_write_str("  eip     = "); _isr_write_hex32(frame->eip);      _isr_write_str("\r\n");
    _isr_write_str("  cs      = "); _isr_write_hex32(frame->cs);       _isr_write_str("\r\n");
    _isr_write_str("  eflags  = "); _isr_write_hex32(frame->eflags);   _isr_write_str("\r\n");
    _isr_write_str("  eax     = "); _isr_write_hex32(frame->eax);      _isr_write_str("\r\n");
    _isr_write_str("  ecx     = "); _isr_write_hex32(frame->ecx);      _isr_write_str("\r\n");
    _isr_write_str("  edx     = "); _isr_write_hex32(frame->edx);      _isr_write_str("\r\n");
    _isr_write_str("  ebx     = "); _isr_write_hex32(frame->ebx);      _isr_write_str("\r\n");
    _isr_write_str("  esp     = "); _isr_write_hex32(frame->esp);      _isr_write_str("\r\n");
    _isr_write_str("  ebp     = "); _isr_write_hex32(frame->ebp);      _isr_write_str("\r\n");
    _isr_write_str("  esi     = "); _isr_write_hex32(frame->esi);      _isr_write_str("\r\n");
    _isr_write_str("  edi     = "); _isr_write_hex32(frame->edi);      _isr_write_str("\r\n");
    _isr_write_str("  ds      = "); _isr_write_hex32(frame->ds);       _isr_write_str("\r\n");
