...
typedef void (*interrupt_service_routine_function_t)(void);

static const interrupt_service_routine_function_t idt_exception_stubs[IDT_EXCEPTION_VECTOR_COUNT] = {
...
static const interrupt_service_routine_function_t idt_irq_stubs[IDT_IRQ_VECTOR_COUNT] = {
...
static void interrupt_descriptor_table_install_vector_range(InterruptDescriptorTable_t *idt, size_t base,
                                                            const interrupt_service_routine_function_t *stubs,
                                                            size_t count)
{
...
void interrupt_descriptor_table_initialize(InterruptDescriptorTable_t *idt)
{
    ...
    interrupt_descriptor_table_encode_flat_entry(&idt->entries[0x80u], (void *) isr128, GDT_KERNEL_CODE_SELECTOR,
