...
void write_ioapic_routes_info(Serial_t *serial)
{
         ...
         ++route_index)
    {
        ...
        serial_write_int(
            serial, (int32_t) input_output_advanced_programmable_interrupt_controller_get_programmed_route_io_apic_index(
                       route_index));
        ...
        serial_write_hex16(
            serial, input_output_advanced_programmable_interrupt_controller_get_programmed_route_iso_flags(route_index));
        serial_write_string(serial, "\n");
    }
}
