 ...
 *
 * Implements the hardware_abstraction_layer_graphics_memory_* contract over the kernel pinned-memory
 ...
 * the scatter-gather list; hardware_abstraction_layer_graphics_memory_physical_address resolves one
