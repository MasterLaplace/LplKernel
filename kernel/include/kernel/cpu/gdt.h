 ...
 *
 * @file gdt.h
 * @brief Global Descriptor Table layouts and loading.
 *
...
/**
 * @brief Small Kernel Setup (from OSDev wiki GDT_Tutorial "Small Kernel Setup" table)
 *
...
/**
 * @brief Flat / Long Mode Setup - 32-bit Protected Mode (from OSDev wiki "Flat / Long Mode Setup"
 * first table)
 *
...
/**
 * @brief Flat / Long Mode Setup - 64-bit Long Mode (from OSDev wiki "Flat / Long Mode Setup" second
 * table)
 *
...
/**
 * @name Canonical selector values for the current flat 32-bit GDT layout
 * @{
 */
